...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    ...
    //return of(HEROES); // fetching static mock-data
  }
  ...
  */
  ...
  getHero(id: Number): Observable<Hero> {
    ...
    return this.http.get<Hero>(url).pipe(tap(_ => this.log(`Fethed hero id=${id}`)), catchError(this.handleError<Hero>(`getHero id=${id}`))
    );

    //return of(HEROES.find(hero => hero.id === id)); // old way from static file
  }
